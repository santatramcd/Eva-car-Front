      ...
      <div class="row division-position">
        ...
        <div class="col-md-8">
          ...
          >
            ...
            >
              <div class="card card-body paramfaq" v-html="item.message"></div>
            </div>
          </div>
        </div>
      </div>
...
const dataAuto = [
  ...
  },
  {
    ...
    title:
      "2.1 Que se passe-t-il si je suis impliqué dans un accident de voiture ?",
  ...
  {
    title:
      "5.4 Puis-je choisir des endroits différents pour la livraison et la restitution du véhicule ?",
    message: `Oui. Et comme Seychelles est une si petite île, nous ne facturons pas de frais supplémentaires.`,
  },
  {
    title:
      "5.5 Le réservoir d'essence est-il plein lors de l'enlèvement de la voiture ?",
  ...
  {
    title:
      "7.3 La réservation de voiture en ligne avec Eva Car Rental est-elle sécurisée ?",
